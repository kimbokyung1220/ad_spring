...
public class KwdDto {
    ...
    public KwdDto(Long adId, Long agroupId, Integer adUseConfigYn, Integer adActYn, ZonedDateTime regTime, Long dadDetId, Integer dadActYn, Integer dadUseConfigYn, Long kwdId, String kwdName) {
        this.adId = adId;
